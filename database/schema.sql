...
CREATE TABLE public.products (
  ...
  attribute_id UUID REFERENCES public.product_attributes(id),
...
CREATE POLICY "Admins can manage product attributes" ON public.product_attributes FOR ALL USING (public.is_admin());
CREATE POLICY "Public can view active product attributes" ON public.product_attributes FOR SELECT USING (is_active = true);
