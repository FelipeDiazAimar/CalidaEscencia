...
async function fixSubcategoriesRLSNoUsers() {
  try {
    console.log('Fixing RLS policies for subcategories table (without users table dependency)...');

    // SQL to fix RLS policies (without users table reference)
    const sql = `
    ...
    console.log('Now using authenticated users instead of checking users table.');
